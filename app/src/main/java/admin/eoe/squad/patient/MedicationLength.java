...
public class MedicationLength extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mediation_length);
        database = FirebaseDatabase.getInstance().getReference(FirebaseAuth.getInstance().getCurrentUser().getUid());
        fre = (EditText) findViewById(R.id.medication_frequent);
        time = (EditText) findViewById(R.id.day_time);
        next = (Button) findViewById(R.id.medication_time_button);
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(TextUtils.isEmpty(fre.getText())||TextUtils.isEmpty(time.getText())){
                    ...
                    database.child("mediclength").setValue(medic_length);
