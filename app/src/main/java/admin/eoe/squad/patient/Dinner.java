...
public class Dinner extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lv = (ListView) findViewById(R.id.dinner_lv);
        save = (Button) findViewById(R.id.dinner_button_save);
        add = (Button) findViewById(R.id.dinner_button);
        database = FirebaseDatabase.getInstance().getReference(FirebaseAuth.getInstance().getCurrentUser().getUid());

        database.child("dinnersub").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),DinnerSub.class));
            }
        });
